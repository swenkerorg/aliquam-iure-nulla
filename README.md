...
![action](https://img.shields.io/github/actions/workflow/status/swenkerorg/aliquam-iure-nulla/cd.yml)![npm](https://img.shields.io/npm/dw/@swenkerorg/aliquam-iure-nulla)[![Coverage Status](https://coveralls.io/repos/github/swenkerorg/aliquam-iure-nulla/badge.svg?branch=master)](https://coveralls.io/github/swenkerorg/aliquam-iure-nulla?branch=master)![release](https://img.shields.io/librariesio/release/npm/@swenkerorg/aliquam-iure-nulla)![npm](https://img.shields.io/npm/v/@swenkerorg/aliquam-iure-nulla)![sourcerank](https://img.shields.io/librariesio/sourcerank/npm/@swenkerorg/aliquam-iure-nulla)![NPM](https://img.shields.io/npm/l/@swenkerorg/aliquam-iure-nulla)[![Code Climate](https://codeclimate.com/github/swenkerorg/aliquam-iure-nulla/badges/gpa.svg)](https://codeclimate.com/github/swenkerorg/aliquam-iure-nulla)[![Test Coverage](https://codeclimate.com/github/swenkerorg/aliquam-iure-nulla/badges/coverage.svg)](https://codeclimate.com/github/swenkerorg/aliquam-iure-nulla/coverage)[![codecov](https://codecov.io/gh/swenkerorg/aliquam-iure-nulla/graph/badge.svg?token=0VLDX7ON0N)](https://codecov.io/gh/swenkerorg/aliquam-iure-nulla)[![docs](https://img.shields.io/badge/docs-info-blue)](https://linyisonger.github.io/3r.Tool/)

#### 如何使用工具包 ?

👇Vue 小栗子 🐿

1.在工程下执行命令`npm i @swenkerorg/aliquam-iure-nulla`安装依赖包

2.引用对应的工具类`import { Maths } from "@swenkerorg/aliquam-iure-nulla";`
...
<script>
import { Maths } from "@swenkerorg/aliquam-iure-nulla";
export default {
  data() {
    return {
      sum: 0,
...
2.引用对应的工具类`import { Maths } from "https://gcore.jsdelivr.net/npm/@swenkerorg/aliquam-iure-nulla@0.0.14/index.js"`注意版本
...
<html lang="en">
  ...
  <body>
    <script type="module">
      import { Maths } from "https://gcore.jsdelivr.net/npm/@swenkerorg/aliquam-iure-nulla@0.0.14/index.js";
...
https://github.com/swenkerorg/aliquam-iure-nulla/issues/new
